...
namespace UFrame.DressBundle.Browser
{
    ...
    internal class AssetBundleInspectTab
    {
        ...
        internal void OnEnable(Rect pos)
        {
            ...
            dataPath += "/Library/DressAssetBundleBrowserInspect.asset";

            if (File.Exists(dataPath))
            {
                var objs = UnityEditorInternal.InternalEditorUtility.LoadSerializedFileAndForget(dataPath);
                if(objs != null && objs.Length > 0)
                    m_Data = objs[0] as InspectTabData;
            }
            if (m_Data == null)
                m_Data = ScriptableObject.CreateInstance<InspectTabData>();
        ...
        internal void OnDisable()
        {
            ...
            UnityEditorInternal.InternalEditorUtility.SaveToSerializedFileAndForget(new Object[] { m_Data }, dataPath, true);
        }
        ...
        [System.Serializable]
        internal class InspectTabData:ScriptableObject
        {
            [SerializeField]
