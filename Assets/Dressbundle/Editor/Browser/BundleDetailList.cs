...
using UFrame.DressBundle.Browser.Models;
...
namespace UFrame.DressBundle.Browser
{
    ...
    {
        HashSet<Models.BundleDataInfo> m_Selecteditems;
        Rect m_TotalRect;
        ...
        {
            m_Selecteditems = new HashSet<Models.BundleDataInfo>();
            showBorder = true;
        }
        ...
        protected override void RowGUI(RowGUIArgs args)
        {
            ...
            else
            {
                ...
                if (args.item.depth == 1 &&
                    ...
                    GUI.color = Models.Model.k_LightGrey;
                base.RowGUI(args);
                GUI.color = old;
            }
        }
        ...
        protected override void SelectionChanged( IList<int> selectedIds )
        {
            ...
            DressAssetBundleBrowserMain.instance.m_ManageTab.SetAssetListSelection( pathList );
        }
        ...
        internal static TreeViewItem AppendBundleToTree(Models.BundleDataInfo bundle)
        {
            ...
            if(depList.Count > 0)
            {
                ...
                foreach (var dep in bundle.GetBundleDependencies())
                {
                    ...
                    newItem.icon = Model.GetBundleIcon(Model.DataSource.IsRefBundle(dep.m_BundleName));
        ...
        internal void SetItems(IEnumerable<Models.BundleInfo> items)
        {
        ...
        internal void CollectBundles(Models.BundleInfo bundle)
        {
            var bunData = bundle as Models.BundleDataInfo;
            if (bunData != null)
                m_Selecteditems.Add(bunData);
            else
            {
                var bunFolder = bundle as Models.BundleFolderInfo;
