...
namespace UFrame.DressBundle.Browser.Models
{
    ...
    {   
        ...
        public override string displayName
        {
            get
            {
                return DressAssetBundleBrowserMain.instance.m_ManageTab.hasSearch ? m_Bundle.m_Name.fullNativeName : m_Bundle.displayName;
            }
        }
    }
    ...
    internal class BundleDataInfo : BundleInfo
    {
        ...
        ~BundleDataInfo()
        {
            ...
            {
                Browser.Models.Model.UnRegisterAsset(asset, m_Name.fullNativeName);
            }
        }
        ...
        internal override void RefreshAssetList()
        {
            ...
            var assets = Browser.Models.Model.DataSource.GetAssetPathsFromAssetBundle(m_Name.fullNativeName);
            foreach(var assetName in assets)
            {
                ...
                if (System.String.IsNullOrEmpty(bundleName))  
                {
                    ...
                    while(!System.String.IsNullOrEmpty(partialPath) && 
        ...
        private void GatherDependencies(AssetInfo asset, string parentBundle = "")
        {
            ...
            foreach (var ai in deps)
            {
                ...
                var bundleName = Browser.Models.Model.DataSource.GetImplicitAssetBundleName(ai.fullAssetName);
        ...
        internal override BundleTreeItem CreateTreeView(int depth)
        {
            ...
            if (isSceneBundle)
                ...
                return new BundleTreeItem(this, depth, Model.GetBundleIcon(Model.DataSource.IsRefBundle(m_Name.bundleName)));
        }
    ...
    internal class BundleFolderConcreteInfo : BundleFolderInfo
    {
        ...
        {
            if(m_Children.ContainsKey(info.displayName))
            {
                Debug.LogError("add child key exists:" + info.displayName);
                m_Children[info.displayName] = info;
            }
            else
            {
    ...
    internal class BundleVariantFolderInfo : BundleFolderInfo
    {
        ...
        internal override BundleTreeItem CreateTreeView(int depth)
        {
                ...
                ((m_Children.First().Value as BundleVariantDataInfo).IsSceneVariant()))
            {
                ...
                icon = Model.GetBundleIcon(Model.DataSource.IsRefBundle(m_Name.bundleName));
